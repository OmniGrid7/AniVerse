...
export default function AccessibilitySidebar({
  ...
  const shortcutItems = [
    ...
    { key: "signup", label: "Profile", icon: <UserIcon /> }
  ];
    ...
    <aside className="settings-sidebar" aria-labelledby="settingsTitle">
      ...
      <div className="workspace-panels">
        <section className="workspace-card">
          <h2 id="settingsTitle">Creator Workspace</h2>
          <p>Use this panel to move faster across your writing, recommendations, and profile tools.</p>
